import { CREATE_LANE, CREATE_LANES, UPDATE_LANE, DELETE_LANE, EDIT_LANE, MOVE_BETWEEN_LANES, REMOVE_FROM_LANE, PUSH_TO_LANE, REODER_LANE_NOTES } from './LaneActions';
...
export default function lanes(state = initialState, action) {
  switch (action.type) {
    ...
    case REODER_LANE_NOTES: {
      const lane = state[action.laneId].notes = action.notes;
